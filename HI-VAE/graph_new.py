...
def HVAE_graph(model_name, types_file, batch_size, n_vis, learning_rate=1e-3, z_dim=2, y_dim=1, s_dim=2, y_dim_partition=[]):
    ...
    samples_zgen, test_params_zgen, log_p_x_zgen, log_p_x_missing_zgen = model.fixed_decoder(batch_data_list, X_list, miss_list_VP,miss_list, types_list, batch_size, z_dim, y_dim_output, y_dim_partition, s_dim, tau, normalization_params,zcodes,scodes)
